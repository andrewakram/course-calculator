...
<head><base href="../../">
    ...
    <meta property="og:url" content="http://Course-Calculator.com/metronic" />
    ...
    <div class="d-flex flex-column flex-xl-row flex-column-fluid">
        ...
        <div class="d-flex flex-column flex-lg-row-fluid">
            ...
            <div class="d-flex flex-row-fluid flex-center p-10">
                ...
                <div class="d-flex flex-column">
                    <!--begin::Logo-->
                    <a href="{{ url('admin/dist/') }}/../../demo1/dist/index.html" class="mb-15">
                        <img alt="Logo" src="{{ url('admin/dist/') }}/assets/media/logos/logo-1.svg" class="h-40px" />
                    </a>
                    <!--end::Logo-->
                    <!--begin::Title-->
            ...
            <!--end::Wrapper-->
            <!--begin::Illustration-->
            <div class="d-flex flex-row-auto bgi-no-repeat bgi-position-x-center bgi-size-contain bgi-position-y-bottom min-h-200px min-h-xl-450px mb-xl-10" style="background-image: url(assets/media/illustrations/sketchy-1/8.png"></div>
            <!--end::Illustration-->
        </div>
        <!--begin::Aside-->
        <!--begin::Content-->
        <div class="flex-row-fluid d-flex flex-center justfiy-content-xl-first p-10">
            ...
            <div class="d-flex flex-center p-15 shadow bg-body rounded w-100 w-md-550px mx-auto ms-xl-20">
                <!--begin::Form-->
                <form action="{{route('web.login')}}" method="post" class="form" novalidate="novalidate" id="kt_free_trial_form">
                    @csrf
                    <!--begin::Heading-->
                    <div class="text-center mb-10">
                        <!--begin::Title-->
                        <h1 class="text-dark mb-3">Sign In Now </h1>
                        <!--end::Title-->
                        <!--begin::Link-->
...
<!--begin::Page Custom Javacript(used by this page)-->
<script src="{{ url('admin/dist/') }}/assets/js/custom/authentication/sign-up/free-trial.js"></script>
