            ...
            <div class="d-flex align-items-stretch" id="kt_header_nav">
                ...
                <div class="header-menu align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="header-menu"
                    ...
                    <div
                        ...
                        <div class="menu-item me-lg-1">
                            <a class="menu-link @if(request()->segment(2) == 'countries') active @endif py-3"
                               href="{{route('admin.countries')}}">
                                <span class="menu-title">الدول</span>
                            </a>
                        </div>
                        <div class="menu-item me-lg-1">
                            <a class="menu-link @if(request()->segment(2) == 'cities') active @endif py-3"
                               href="{{route('admin.cities')}}">
                                <span class="menu-title">المدن</span>
                            </a>
                        </div>
                        <div class="menu-item me-lg-1">
                            <a class="menu-link @if(request()->segment(2) == 'courses') active @endif py-3"
