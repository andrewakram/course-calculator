...
{{--                </div>--}}
                <div class="menu-item">
                    <a class="menu-link @if(request()->segment(2) == 'countries' ) active @endif"
                ...
                <div class="menu-item">
                    <a class="menu-link @if(request()->segment(2) == 'cities-courses' ) active @endif"
                       href="{{route('admin.cities-courses')}}"
                    >
                        <span class="menu-icon">
                            <i class="fa fa-circle"></i>
                        </span>
                        <span class="menu-title">كورسات المدن</span>
                    </a>
                </div>

                <div class="menu-item">
                    <a class="menu-link @if(request()->segment(2) == 'centers' ) active @endif"
                       href="{{route('admin.centers')}}"
                    >
                        <span class="menu-icon">
                            <i class="fa fa-circle"></i>
                        </span>
                        <span class="menu-title">سنتر الكورسات </span>
                    </a>
                </div>

                <div class="menu-item">
                    <a class="menu-link @if(request()->segment(2) == 'accomodations' ) active @endif"
                       href="{{route('admin.accomodations')}}"
                    >
                        <span class="menu-icon">
                            <i class="fa fa-circle"></i>
                        </span>
                        <span class="menu-title">الاقامة</span>
                    </a>
                </div>
