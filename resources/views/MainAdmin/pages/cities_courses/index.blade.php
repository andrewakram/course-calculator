            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    ...
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">
                        ...
                        <!--end::Separator-->
                        <!--begin::Description-->
                        <small class=" fs-3 fw-bold my-1 ms-1" style="color: #5482d5">كورسات المدن</small>
                        <!--end::Description-->
                    </h1>
                    <!--end::Title-->
                </div>
                ...
                <div class="d-flex align-items-center py-1">
                    <!--begin::Wrapper-->
                    <!--begin::Button-->
                    <a href="{{route('admin.cities-courses.create')}}" class="btn btn-sm btn-success"
...
{{--                                <th class=" min-w-100px">الاسم (عربي)</th>--}}
                                <th class=" min-w-100px">الكورس</th>
                                <th class=" min-w-100px">السعر</th>
                                <th class=" min-w-100px">عدد الاسابيع</th>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#kt_ecommerce_products_table").DataTable({
                    ...
                    },
                    {
                        ...
                        customize: function (win) {
                            $(win.document.body)
                                ...
                                '                        <tbody> ' +
                                '                                <tr>' +
                                '                                    <td style="text-align: center">  <p style="padding-right:150px">Course-Calculator</p></td>' +
                ...
                ajax: '{{ route('admin.cities-courses.datatable') }}',
                "columns": [
                    {"data": 'select', "searchable": false, "orderable": false},
                    {data: 'DT_RowIndex', name: 'DT_RowIndex', "searchable": false, "orderable": false},
                    // {"data": "title_ar", "searchable": true, "orderable": false},
                    {"data": "course_name", "searchable": true, "orderable": false},
                    {"data": "price_per_week", "searchable": true, "orderable": false},
                    {"data": "no_of_weeks", "searchable": true, "orderable": false},
                    {"data": "city_name", "searchable": true, "orderable": false},
                    {"data": "country_name", "searchable": true, "orderable": false},
        ...
        $(document).on("click", ".delete", function () {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: '{{route('admin.cities-courses.delete')}}',
                        type: "post",
