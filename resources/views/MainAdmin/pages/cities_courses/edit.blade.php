    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">
                            <a href="{{route('admin.cities-courses')}}" class="text-muted text-hover-primary">كورسات المدن</a>
                        </li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                <!--begin::Form-->
                <form action="{{route('admin.cities-courses.update')}}" method="post" enctype="multipart/form-data" class="form d-flex flex-column flex-lg-row gap-7 gap-lg-10" >
                @csrf
                                        ...
                                        <!--end::Input group-->
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <select name="country_id" required class="country_id form-select form-select-solid" data-kt-select2="true" >
                                                    @foreach($countries as $country)
                                                        <option value="{{$country->id}}" {{$row->country_id == $country->id ? "selected" : ""}}>{{$country->name_en}}</option>
                                                    @endforeach
                                                </select>
                                                ...
                                                <div class="mb-10 fv-row">
                                                    ...
                                                    <select name="city_id" required class="city_id form-select mb-2" data-control="select2" data-hide-search="false" data-placeholder="إختر المدينة" >
                                                        ...
                                                        @foreach($cities as $city)
                                                            <option value="{{$city->id}}" {{$row->city_id == $city->id ? "selected" : ""}}>{{$city->name_en}}</option>
                                                        @endforeach
                                                    </select>
                                                    <!--end::Select2-->
                                                </div>
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <select name="course_id" required class=" form-select form-select-solid" data-kt-select2="true" >
                                                    @foreach($courses as $course)
                                                        <option value="{{$course->id}}" {{$row->course_id == $course->id ? "selected" : ""}}>{{$course->name_en}}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <input type="number" required name="no_of_weeks" class="form-control mb-2"
                                                       placeholder="عدد الاسابيع" value="{{$row->no_of_weeks}}"/>
                                                <!--end::Input-->
                                                <!--begin::Description-->
                                            </div>
                                            <!--end::Input group-->
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <input type="number" required name="price_per_week" class="form-control mb-2"
                                                       placeholder="سعر الاسبوع" value="{{$row->price_per_week}}"/>
                                                <!--end::Input-->
                                                <!--begin::Description-->
                                            </div>
                                            <!--end::Input group-->
