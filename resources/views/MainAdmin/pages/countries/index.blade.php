...
{{--                                <th class=" min-w-10px">العنوان (عربي)</th>--}}
                                <th class=" min-w-10px">العنوان (انجليزي)</th>
{{--                                <th class=" min-w-10px">العملة (عربي)</th>--}}
                                <th class=" min-w-10px">العملة (انجليزي)</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="delete_multi_form" method="post" action="{{route('admin.countries.deleteMulti')}}">
                        @csrf
        ...
        $(document).ready(function () {
            ...
            $("#kt_ecommerce_products_table").DataTable({
                ...
                "columns": [
                    ...
                    // {"data": "name_ar", "searchable": true, "orderable": false},
                    {"data": "name_en", "searchable": true, "orderable": false},
                    // {"data": "currency_ar", "searchable": true, "orderable": false},
                    {"data": "currency_en", "searchable": true, "orderable": false},
                    {"data": "active", "searchable": true, "orderable": false},
