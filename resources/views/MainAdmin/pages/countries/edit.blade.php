            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">
                            <a href="{{route('admin.countries')}}" class="text-muted text-hover-primary">الدول</a>
                        </li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
...
{{--                                                <!--begin::Label-->--}}
{{--                                                <label class="required form-label">إسم الدولة (عربي)</label>--}}
{{--                                                <!--end::Label-->--}}
{{--                                                <!--begin::Input-->--}}
{{--                                                <input type="text" required name="name_ar" class="form-control mb-2"--}}
{{--                                                       placeholder="إسم الدولة (عربي)" value="{{$row->name_ar}}"/>--}}
{{--                                                <!--end::Input-->--}}
{{--                                                <!--begin::Description-->--}}
{{--                                            </div>--}}
                                            <!--end::Input group-->
                                            ...
                                            <div class="mb-10 fv-row">
                                                <!--begin::Label-->
                                                <label class="required form-label">إسم الدولة (إنجليزي)</label>
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" required name="name_en" class="form-control mb-2" disabled
                                                       placeholder="إسم الدولة (إنجليزي)" value="{{$row->name_en}}"/>
                                                <!--end::Input-->
                                                <!--begin::Description-->
                                            </div>
                                            <!--end::Input group-->
                                            ...
                                            <div class="mb-10 fv-row">
                                                <!--begin::Label-->
                                                <label class="required form-label">إسم العملة (إنجليزي)</label>
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" required name="currency_en" class="form-control mb-2"
                                                       placeholder="إسم العملة (إنجليزي)" value="{{$row->currency_en}}"/>
                                                <!--end::Input-->
                                                <!--begin::Description-->
                                            </div>
                                            <!--end::Input group-->
                        ...
                        <div class="d-flex justify-content-end">
                            <!--begin::Button-->
                            <a href="{{route('admin.countries')}}" id="kt_ecommerce_add_product_cancel"
